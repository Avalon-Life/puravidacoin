...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("PuraVidaCoins"));
    case mBTC: return QString(QObject::tr("Milli-PuraVidaCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-PuraVidaCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
